...
query = _descriptor.FieldDescriptor(
    name="query",
    full_name="protobuf_json_test.query",
    index=0,
    number=100,
    type=9,
    cpp_type=9,
    ...
    default_value=b"test ext".decode("utf-8"),
    message_type=None,
    enum_type=None,
...
long = _descriptor.FieldDescriptor(
    name="long",
    full_name="protobuf_json_test.long",
    index=1,
    number=101,
    type=4,
    cpp_type=4,
...
_TESTMESSAGE_NESTEDMSG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="protobuf_json_test.TestMessage.NestedMsg.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="title",
            full_name="protobuf_json_test.TestMessage.NestedMsg.title",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="url",
            full_name="protobuf_json_test.TestMessage.NestedMsg.url",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_TESTMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="protobuf_json_test.TestMessage.id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="query",
            full_name="protobuf_json_test.TestMessage.query",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="flag",
            full_name="protobuf_json_test.TestMessage.flag",
            index=2,
            number=3,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="test_enum",
            full_name="protobuf_json_test.TestMessage.test_enum",
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="nested_msg",
            full_name="protobuf_json_test.TestMessage.nested_msg",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="nested_msgs",
            full_name="protobuf_json_test.TestMessage.nested_msgs",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="rep_int",
            full_name="protobuf_json_test.TestMessage.rep_int",
            index=6,
            number=7,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="b",
            full_name="protobuf_json_test.TestMessage.b",
            index=7,
            number=8,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="bs",
            full_name="protobuf_json_test.TestMessage.bs",
            index=8,
            number=9,
            type=12,
            cpp_type=9,
...
TestMessage = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "NestedMsg": _reflection.GeneratedProtocolMessageType(
            "NestedMsg",
            (_message.Message,),
            {
