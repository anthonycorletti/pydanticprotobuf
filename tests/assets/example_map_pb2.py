...
_PAYLOAD_CENTRY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="Payload.CEntry.value",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
...
_PAYLOAD_EENTRY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="Payload.EEntry.value",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
Payload = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "CEntry": _reflection.GeneratedProtocolMessageType(
            "CEntry",
            (_message.Message,),
            {
        ...
        "wow": _reflection.GeneratedProtocolMessageType(
            "wow",
            (_message.Message,),
            {
        ...
        "EEntry": _reflection.GeneratedProtocolMessageType(
            "EEntry",
            (_message.Message,),
            {
        ...
        "wows": _reflection.GeneratedProtocolMessageType(
            "wows",
            (_message.Message,),
            {
